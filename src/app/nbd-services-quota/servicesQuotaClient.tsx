...
export default function NbdServicesQuotaClient() {
  ...
  const rows = useQuery(api.quotas.listNbdServiceByMonthKeys, { monthKeys });
  const updateQuota = useMutation(api.quotas.updateNbdServiceQuota);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Квоты NBD на AI-подписки</CardTitle>
      </CardHeader>
      <CardContent>
